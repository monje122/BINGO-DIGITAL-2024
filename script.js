const supabaseUrl = 'https://bvwgjwoobhfcggcvkrcm.supabase.co';
const supabase = window.supabase.createClient(supabaseUrl, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ2d2dqd29vYmhmY2dnY3ZrcmNtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMwOTUxMjUsImV4cCI6MjA2ODY3MTEyNX0.0oz9o3uhe6rc8n1dJmtX2JKCR2Qu1gVwML905rt4Zq0');
...
async function consultarCartones() {
  ...
  data.forEach(item => {
    item.cartones.forEach(num => {
      ...
      img.src = `${supabaseUrl}/storage/v1/object/public/cartones/SERIAL_BINGODIGITAL2024_CARTON_${String(num).padStart(5, '0')}.jpg`;
...
function abrirModalCarton(numero, elemento) {
  ...
  img.src = `${supabaseUrl}/storage/v1/object/public/cartones/SERIAL_BINGODIGITAL2024_CARTON_${String(numero).padStart(5, '0')}.jpg`;
